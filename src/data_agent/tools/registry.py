...
TOOL_GROUPS: dict[str, set[str]] = {
    "core": {
        ...
        "tool_search",
        "record_data_requirement", "record_analysis_objective", "record_analysis_spec", "record_analysis_plan",
        "record_exploratory_finding", "record_validated_finding", "record_evidence_record",
        "record_insight_record", "record_expert_insight",
    },
    "eda": {
...
DEFAULT_TOOL_CAPABILITIES: dict[str, ToolCapability] = {
    ...
    "record_analysis_objective": _cap("artifact.analysis_objective", "analysis_artifact", ["planning"], evidence_fields=["question_type", "business_object", "decision_risk"]),
    ...
    "record_exploratory_finding": _cap("artifact.exploratory_finding", "analysis_artifact", ["exploration"], evidence_fields=["finding", "candidate_hypotheses"]),
    "record_validated_finding": _cap("artifact.validated_finding", "evidence", ["validation"], evidence_fields=["claim", "validation_method", "statistical_explanation"]),
    ...
    "record_expert_insight": _cap("artifact.expert_insight", "insight", ["evidence", "report"], evidence_fields=["business_meaning", "recommendation_confidence", "next_analysis"]),
