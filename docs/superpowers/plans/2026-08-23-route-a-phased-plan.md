...
| Gate C | 真实 Provider 冻结与授权 | **主模型 R01–R07 阶梯批次 7/7 通过（授权 21 次、实际恰好 7 次、全部第一档 2000 命中、零升档触发；R05 三次观测的 reasoning 桶 over_4096 → 257_to_1024 → 1_to_256 确认原截断为推理长度方差）。主模型批次闭环。旅程级仪器就绪：离线回放构架（R07 实测 3 轮结构，Provider 0）+ 可数执行器（每轮单次请求、冻结阶梯、轮次硬上限）；R07 旅程试点首次授权执行失败（4/18 次调用，全 profiling 无实质分析、最终轮部分截断），诊断出执行器升档条件与分析质量守卫两处缺陷并已修复（见 [失败诊断收据](../../audit/2026-08-25-gate-c-journey-r07-failure-diagnosis.md)），重跑已冻结待新授权。R08/R09 取舍建议书已提交（R08 零调用；R09 一条路由旅程）。异构候选 kimi-k3 已定，待执行器扩展与凭据。** | [阶梯批次预检](../../audit/2026-08-25-gate-c-main-model-r01-r07-ladder-preflight.md)、[阶梯批次报告](../../audit/2026-08-25-gate-c-main-model-r01-r07-ladder-batch-report.json)、[旅程回放构架与 R07 结构测量](../../audit/2026-08-25-gate-c-journey-replay-harness.md)、[R07 旅程试点预检](../../audit/2026-08-25-gate-c-journey-r07-preflight.md)、[R08/R09 取舍建议书](../../audit/2026-08-25-gate-c-r08-r09-scoping-proposal.md)、[R05 预算阶梯修复与 canary 预检](../../audit/2026-08-25-gate-c-r05-budget-ladder-remediation.md)、[R05 阶梯 canary 报告](../../audit/2026-08-25-gate-c-r05-budget-ladder-canary-report.json)、[2000-token 批次报告](../../audit/2026-08-25-gate-c-main-model-r01-r07-2000-batch-report.json)、[截断诊断修复](../../audit/2026-08-25-gate-c-length-truncation-remediation.md)；更早批次见 [四场景预检](../../audit/2026-08-25-gate-c-exact-call-preflight.md)、[审计批次](../../audit/2026-08-25-gate-c-main-model-r01-r07-audited-batch.md)、[JSON-object 批次](../../audit/2026-08-25-gate-c-main-model-r01-r07-json-object-batch.md)、[批次 1](../../audit/2026-08-25-gate-c-authorized-batch-1.md)、[批次 2](../../audit/2026-08-25-gate-c-authorized-batch-2-protocol-pass.md) 与 [批次 3](../../audit/2026-08-25-gate-c-authorized-batch-3-grounded-pass.md)：新增 R01/R05/R06 已有真实数据 oracle |
