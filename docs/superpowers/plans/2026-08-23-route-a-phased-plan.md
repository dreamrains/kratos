...
| Gate C | 真实 Provider 冻结与授权 | **首次获授权批次已停止；批内继续策略已重新冻结，待精确授权** | [精确调用预检收据](../../audit/2026-08-25-gate-c-exact-call-preflight.md) 与 [R02 停止收据](../../audit/2026-08-25-gate-c-authorized-r02-stop.md)：R02 仅 1 次非 JSON 后停止；后续批次为每个冻结场景各 1 次、批后统一修复 |
