...
> **状态变更（2026-09-06）：本文件降级为历史实施记录，不再是当前测试或发布入口。** 其中 Gate C/D 批次、矩阵、浏览器旅程和历史收据均已退役；当前边界见[退役的浏览器与 Provider 矩阵](../../testing/retired-browser-provider-matrix.md)和 `tests/TESTING.md`。
...
3. 历史故障矩阵已经退役，仅保留其重新设计边界：[退役的浏览器与 Provider 矩阵](../../testing/retired-browser-provider-matrix.md)。
...
| Gate C | 真实 Provider 冻结与授权 | **主模型 R01–R07 阶梯批次 7/7 通过；kimi-k3 异构批次 v2 通过（4/4、恰好 4 次）。R07 旅程试点四跑后按预承诺**以系统完整性结案**（四跑消耗 23/90：升档×2、守卫引导路由、实质工具可达、澄清挂起、净化收据全部按账；四跑新发现=模型对「上传的」措辞触发澄清提问，属合理产品行为，根因是问题设计与无头上下文不匹配）。R09 路由旅程首跑**确认 curve_fitting 真实可达且被选用**（靶风险闭环）但收尾撞上 cap=wrap-up=8 的仪器缺陷；用户追问 R07 后定位两处仪器根因并已修（旅程缺计划定义的上传阶段→uploads 段经 inbox 真实上传；cap 必须>wrap-up→预检结构性校验），六跑/三跑（授权消耗 10/30、14/36）确认产品形态修复生效（六跑第 1 轮即 load_data、compare_periods/contribute_decomposition 执行；三跑 curve_fitting 第三次路由）但模型在 ≤12 轮内不服从软收尾——按预承诺**旅程级永久结案于系统完整性**。Gate C 汇总：主模型 7/7、kimi-k3 4/4、旅程九跑完整性+路由确证、R08 零调用，本会话 Provider 合计 88 次（全逐次授权）；单旅程序内锚点完成未达成（模型探索深度方差，如实记录）。Gate C 宣告完成（语义与边界见 [最终结案与汇总](../../audit/2026-08-26-gate-c-journey-final-closure.md)）；下一步 Gate D。** | [阶梯批次预检](../../audit/2026-08-25-gate-c-main-model-r01-r07-ladder-preflight.md)、[阶梯批次报告](../../audit/2026-08-25-gate-c-main-model-r01-r07-ladder-batch-report.json)、[kimi v2 结果：通过](../../audit/2026-08-26-gate-c-heterogeneous-kimi-v2-outcome.md)、[R07 四跑结果与结案](../../audit/2026-08-26-gate-c-journey-r07-fourth-outcome.md)、[R09 冻结](../../audit/2026-08-26-gate-c-journey-r09-freeze.md)、[旅程三跑判定](../../audit/2026-08-26-gate-c-journey-r07-third-outcome.md)、[四跑冻结：收尾机制](../../audit/2026-08-26-gate-c-journey-r07-fourth-freeze.md)、[kimi 失败根因与 v2 冻结](../../audit/2026-08-26-gate-c-heterogeneous-kimi-retry-freeze.md)、[旅程回放构架](../../audit/2026-08-25-gate-c-journey-replay-harness.md)、[R07 首跑失败诊断](../../audit/2026-08-25-gate-c-journey-r07-failure-diagnosis.md)、[R07 重跑结果](../../audit/2026-08-25-gate-c-journey-r07-retry-outcome.md)、[R08/R09 取舍建议书](../../audit/2026-08-25-gate-c-r08-r09-scoping-proposal.md)、[R05 预算阶梯修复](../../audit/2026-08-25-gate-c-r05-budget-ladder-remediation.md)、[R05 阶梯 canary 报告](../../audit/2026-08-25-gate-c-r05-budget-ladder-canary-report.json)、[2000-token 批次报告](../../audit/2026-08-25-gate-c-main-model-r01-r07-2000-batch-report.json)、[截断诊断修复](../../audit/2026-08-25-gate-c-length-truncation-remediation.md)；更早批次见 [四场景预检](../../audit/2026-08-25-gate-c-exact-call-preflight.md)、[审计批次](../../audit/2026-08-25-gate-c-main-model-r01-r07-audited-batch.md)、[JSON-object 批次](../../audit/2026-08-25-gate-c-main-model-r01-r07-json-object-batch.md)、[批次 1](../../audit/2026-08-25-gate-c-authorized-batch-1.md)、[批次 2](../../audit/2026-08-25-gate-c-authorized-batch-2-protocol-pass.md) 与 [批次 3](../../audit/2026-08-25-gate-c-authorized-batch-3-grounded-pass.md)：新增 R01/R05/R06 已有真实数据 oracle |
| Gate D | 发布候选审阅 | **当前 `ea127a94…07e8` 已由用户声明为本地发布候选；授权提交与普通推送，未授权部署** | [当前候选声明](../../audit/2026-08-28-gate-d-ea127-local-release-candidate-declaration.md)与[当前 L4 收据](../../audit/2026-08-28-gate-d-ea127-l4-execution-and-candidate-decision.md)：完整集合 2342 passed / 9 skipped、定向契约 66 passed、真实浏览器 L3 与当前 L4（38 / 96 次）同 digest 通过；Workbench 即时投影残余已转入[专项交接](../../audit/2026-08-28-sse-workbench-lifecycle-special-handoff.md)，不声称无刷新多轮 Web 体验完全通过；历史 `e7ec4011…` 的提交、推送与本机部署收据仍保留，但不得冒充当前源码证据 |

> 2026-08-26 复审更新：Gate C 的历史收据与系统完整性测量保留，但 R07 六跑、R09 三跑均未在冻结轮次内形成最终回答；随后引入的受控最终化修复改变了受控源码。故 Gate C 不得作为当前 digest 的发布候选通过证据，须以 `2026-08-26-gate-c-finalization-remediation-preflight.md` 的边界完成当前源码重验后，才可进入 Gate D 的通过判定。
