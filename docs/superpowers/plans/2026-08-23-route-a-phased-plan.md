...
| Gate C | 真实 Provider 冻结与授权 | **四场景历史批次通过；R01–R07 主模型批次已重新冻结，待精确授权** | [四场景预检](../../audit/2026-08-25-gate-c-exact-call-preflight.md)、[R01–R07 主模型预检](../../audit/2026-08-25-gate-c-main-model-r01-r07-preflight.md)、[R02 停止收据](../../audit/2026-08-25-gate-c-authorized-r02-stop.md)、[批次 1](../../audit/2026-08-25-gate-c-authorized-batch-1.md)、[批次 2](../../audit/2026-08-25-gate-c-authorized-batch-2-protocol-pass.md) 与 [批次 3](../../audit/2026-08-25-gate-c-authorized-batch-3-grounded-pass.md)：新增 R01/R05/R06 已有真实数据 oracle；异构模型和完整 AgentLoop/Web 仍未覆盖 |
