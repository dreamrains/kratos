...
| Gate C | 真实 Provider 冻结与授权 | **主模型 R01–R07 阶梯批次 7/7 通过（授权 21 次、实际恰好 7 次）。旅程级试点两跑均失败但每跑都有净信息：首跑暴露执行器升档条件与质量守卫白名单两处缺陷（已修复）；重跑验证修复生效（升档首次真实触发；守卫引导模型经 tool_search 路由到 compare_periods）但 round_cap=6 耗尽于总结前——三跑已冻结（round_cap 8、至多 24 次）待授权。异构 kimi-k3 批次已冻结（R01/R02/R04/R07 同 prompt、至多 12 次）待授权；执行器已支持 manifest 声明 Provider 与 .env 凭据回退。R08/R09 建议已被接受（R08 零调用；R09 一条路由旅程）。** | [阶梯批次预检](../../audit/2026-08-25-gate-c-main-model-r01-r07-ladder-preflight.md)、[阶梯批次报告](../../audit/2026-08-25-gate-c-main-model-r01-r07-ladder-batch-report.json)、[旅程回放构架](../../audit/2026-08-25-gate-c-journey-replay-harness.md)、[R07 试点预检](../../audit/2026-08-25-gate-c-journey-r07-preflight.md)、[首跑失败诊断](../../audit/2026-08-25-gate-c-journey-r07-failure-diagnosis.md)、[重跑结果与三跑冻结](../../audit/2026-08-25-gate-c-journey-r07-retry-outcome.md)、[kimi 异构预检](../../audit/2026-08-25-gate-c-heterogeneous-kimi-preflight.md)、[R08/R09 取舍建议书](../../audit/2026-08-25-gate-c-r08-r09-scoping-proposal.md)、[R05 预算阶梯修复](../../audit/2026-08-25-gate-c-r05-budget-ladder-remediation.md)、[R05 阶梯 canary 报告](../../audit/2026-08-25-gate-c-r05-budget-ladder-canary-report.json)、[2000-token 批次报告](../../audit/2026-08-25-gate-c-main-model-r01-r07-2000-batch-report.json)、[截断诊断修复](../../audit/2026-08-25-gate-c-length-truncation-remediation.md)；更早批次见 [四场景预检](../../audit/2026-08-25-gate-c-exact-call-preflight.md)、[审计批次](../../audit/2026-08-25-gate-c-main-model-r01-r07-audited-batch.md)、[JSON-object 批次](../../audit/2026-08-25-gate-c-main-model-r01-r07-json-object-batch.md)、[批次 1](../../audit/2026-08-25-gate-c-authorized-batch-1.md)、[批次 2](../../audit/2026-08-25-gate-c-authorized-batch-2-protocol-pass.md) 与 [批次 3](../../audit/2026-08-25-gate-c-authorized-batch-3-grounded-pass.md)：新增 R01/R05/R06 已有真实数据 oracle |
