...
| Gate C | 真实 Provider 冻结与授权 | **批次 1 完整诊断失败；协议修复已重新冻结，待精确授权** | [精确调用预检收据](../../audit/2026-08-25-gate-c-exact-call-preflight.md)、[R02 停止收据](../../audit/2026-08-25-gate-c-authorized-r02-stop.md) 与 [批次 1 收据](../../audit/2026-08-25-gate-c-authorized-batch-1.md)：批次 1 消耗 4 次并暴露必填字段缺失；修复后仍为每个冻结场景各 1 次、批后统一修复 |
