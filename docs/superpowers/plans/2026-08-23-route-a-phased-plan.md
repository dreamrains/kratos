...
| Gate C | 真实 Provider 冻结与授权 | **主模型 R01–R07 阶梯批次 7/7 通过（授权 21 次、实际恰好 7 次、全部第一档 2000 命中、零升档触发；R05 三次观测的 reasoning 桶 over_4096 → 257_to_1024 → 1_to_256 确认原截断为推理长度方差）。主模型批次闭环。旅程级覆盖已迈出第一步：离线回放构架落地，R07 实测 3 轮结构（Provider 0）。Gate C 整体未完成——旅程级可数执行器与授权单、异构模型子集、R08/R09 取舍仍需单独冻结授权** | [阶梯批次预检](../../audit/2026-08-25-gate-c-main-model-r01-r07-ladder-preflight.md)、[阶梯批次报告](../../audit/2026-08-25-gate-c-main-model-r01-r07-ladder-batch-report.json)、[旅程回放构架与 R07 结构测量](../../audit/2026-08-25-gate-c-journey-replay-harness.md)、[R05 预算阶梯修复与 canary 预检](../../audit/2026-08-25-gate-c-r05-budget-ladder-remediation.md)、[R05 阶梯 canary 报告](../../audit/2026-08-25-gate-c-r05-budget-ladder-canary-report.json)、[2000-token 批次报告](../../audit/2026-08-25-gate-c-main-model-r01-r07-2000-batch-report.json)、[截断诊断修复](../../audit/2026-08-25-gate-c-length-truncation-remediation.md)；更早批次见 [四场景预检](../../audit/2026-08-25-gate-c-exact-call-preflight.md)、[审计批次](../../audit/2026-08-25-gate-c-main-model-r01-r07-audited-batch.md)、[JSON-object 批次](../../audit/2026-08-25-gate-c-main-model-r01-r07-json-object-batch.md)、[批次 1](../../audit/2026-08-25-gate-c-authorized-batch-1.md)、[批次 2](../../audit/2026-08-25-gate-c-authorized-batch-2-protocol-pass.md) 与 [批次 3](../../audit/2026-08-25-gate-c-authorized-batch-3-grounded-pass.md)：新增 R01/R05/R06 已有真实数据 oracle；异构模型仍未覆盖 |
